...
func (c *infoServiceClient) Projects(ctx context.Context, in *ProjectInfoRequest, opts ...grpc.CallOption) (*ProjectInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/metalstack.io.accounting.api.v1.InfoService/Projects", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infoServiceClient) Tenants(ctx context.Context, in *TenantInfoRequest, opts ...grpc.CallOption) (*TenantInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/metalstack.io.accounting.api.v1.InfoService/Tenants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _InfoService_Projects_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metalstack.io.accounting.api.v1.InfoService/Projects",
	}
...
func _InfoService_Tenants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metalstack.io.accounting.api.v1.InfoService/Tenants",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
