...
func file_metalstack_io_accounting_api_v1_network_traffic_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_metalstack_io_accounting_api_v1_network_traffic_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_accounting_api_v1_network_traffic_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_accounting_api_v1_network_traffic_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_accounting_api_v1_network_traffic_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_accounting_api_v1_network_traffic_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_accounting_api_v1_network_traffic_proto_msgTypes[5].Exporter = func(v any, i int) any {
