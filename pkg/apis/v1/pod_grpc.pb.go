...
func (c *podServiceClient) Added(ctx context.Context, in *PodReport, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/metalstack.io.accounting.api.v1.PodService/Added", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *podServiceClient) Modified(ctx context.Context, in *PodReport, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/metalstack.io.accounting.api.v1.PodService/Modified", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *podServiceClient) Deleted(ctx context.Context, in *PodReport, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/metalstack.io.accounting.api.v1.PodService/Deleted", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *podServiceClient) Usage(ctx context.Context, in *ContainerUsageRequest, opts ...grpc.CallOption) (*ContainerUsageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/metalstack.io.accounting.api.v1.PodService/Usage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PodService_Added_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metalstack.io.accounting.api.v1.PodService/Added",
	}
...
func _PodService_Modified_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metalstack.io.accounting.api.v1.PodService/Modified",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PodService_Deleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metalstack.io.accounting.api.v1.PodService/Deleted",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PodService_Usage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metalstack.io.accounting.api.v1.PodService/Usage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
