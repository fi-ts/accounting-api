...
func (c *s3ServiceClient) BucketStats(ctx context.Context, in *S3BucketReport, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/metalstack.io.accounting.api.v1.S3Service/BucketStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *s3ServiceClient) Usage(ctx context.Context, in *S3UsageRequest, opts ...grpc.CallOption) (*S3UsageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/metalstack.io.accounting.api.v1.S3Service/Usage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedS3ServiceServer) BucketStats(context.Context, *S3BucketReport) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BucketStats not implemented")
}
...
func _S3Service_BucketStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metalstack.io.accounting.api.v1.S3Service/BucketStats",
	}
...
func _S3Service_Usage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metalstack.io.accounting.api.v1.S3Service/Usage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
